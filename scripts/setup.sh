...
if [ ! -f .env ]; then
    ...
    ADMIN_PASSWORD=$(openssl rand -base64 16 2>/dev/null || cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 16 | head -n 1)
...
# Default Admin (auto-generated, change after first login)
...
echo ""
echo "Default admin credentials are stored in the .env file."
echo "  Email: admin@example.com"
echo "  Password: see DEFAULT_ADMIN_PASSWORD in .env"
echo ""

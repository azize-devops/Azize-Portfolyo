...
function BlogPostCard({ post, index, locale }: { post: BlogPostMeta; index: number; locale: Locale }) {
...
export default function BlogPageClient({ posts, tags, locale }: BlogPageClientProps) {
